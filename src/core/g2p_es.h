...
#include "core/num2words_es.h" // #316: spell digits out before phonemizing
...
inline std::string text_to_ipa(const context& ctx, const std::string& text) {
    ...
    auto words = tokenize(core_num2words_es::expand(core_g2p_alnum::split_letters_digits(text)));
